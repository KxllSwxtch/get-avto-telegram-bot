...
def handle_message(message):
    ...
    # Проверка на другие команды
        ...
        about_message = (
            "📌 О компании GetAvto\n\n"
            "🚗 Южнокорейская экспортная компания, занимающаяся поставками автомобилей из Южной Кореи в страны СНГ.\n"
            "🔹 2 года на рынке, более 1000 успешно купленных авто.\n"
            "👍 98% клиентов рекомендуют нас.\n\n"
            "Почему выбирают нас?\n"
            "• Надежность и скорость доставки.\n"
            "• Оперативное решение всех вопросов.\n"
            "• Индивидуальный подход к каждому клиенту.\n"
            "• Доставка в любые регионы СНГ.\n\n"
            "📦 Организуем полный цикл покупки автомобиля — от подбора до доставки в ваш город.\n"
            "📲 Свяжитесь с нами и узнайте стоимость вашего авто прямо сейчас!"
        )
